...
document.addEventListener('DOMContentLoaded', function () {
  var buttons = document.querySelectorAll('.sidebar-btn, nav button');
  ...
  switch (action) {
    ...
    case 'verificar':
      ...
      exampleData.forEach(function (item) {
        ...
        row.innerHTML = "<td>".concat(item.producto, "</td><td>").concat(item.cantidad, "</td><td>").concat(item.precio, "</td>");
